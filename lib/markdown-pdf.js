...
function markdownpdf(opts) {
  ...
  opts.preProcessMd = opts.preProcessMd || function() {
    return through()
  }
  opts.preProcessHtml = opts.preProcessHtml || function() {
    return through()
  }
  ...
  // Make a plain renderer so we don't get double elements
  ...
  tmp.file({
    postfix: ".html"
  }, function(er, tmpHtmlPath, tmpHtmlFd) {
